...
//}
//
//void MazeAlt::InitMaze(int w, int h)
//{
//    m_maze = new CellAlt[w * h];
//    for (int x = 0; x < w; x++)
//    {
//        for (int y = 0; y < h; y++)
//        {
//            int index = y * w + x;
//            m_maze[index].position = sf::Vector2i(x, y);
//        }
//    }
...
//}
//
//sf::Vector2i MazeAlt::GenerateOnSpot(const sf::Vector2i& origin)
//{
//    if (!m_generated) {
...
//}
//
//CellAlt MazeAlt::GetCurrentCell(int index)
//{
...
//}
//
//bool MazeAlt::IsGenerated()
//{
//    return m_generated;
//}
//
//void MazeAlt::BindToVertexArray(sf::VertexArray& vertexArray)
//{
//    if (!this->IsGenerated()) {
//        std::cout << "The MazeAlt is not generated\n";
//        return;
//    }
...
//    //        CellAlt currentCell = this->GetCurrentCell(currentCellIndex);
//
//    //    }
//    //}
//
...
//            {
//                std::cout << "Couldn't render the CellAlt in iteration (x: " << x << " , y: " << y << " )\n";
//                continue;
//            }
